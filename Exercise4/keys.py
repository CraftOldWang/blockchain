...
alice_secret_key_BTC = CBitcoinSecret(
    'cTJ75APUpx74becY74XtzFNUkgtkBSXibe6o1Cza6QZtNVtwmx9D')

# Only to be imported by bob.py
bob_secret_key_BTC = CBitcoinSecret(
    'cUfA2qDWxuYhEVXcrTzZrmohCqhJhnwcKxduFHoQ8GtNw4xQqPHM')
...
alice_secret_key_BCY = CBitcoinSecret.from_secret_bytes(
    x('e43053d544966437f0f1ee011c5cb4514cf7178d3c0d47e511038f72e09909b3'))

# Only to be imported by bob.py
# Bob should have coins!!
bob_secret_key_BCY = CBitcoinSecret.from_secret_bytes(
    x('971dd73fb5e4b17efd472b2839db3227f050e6f03233f0da9ac3f7536662a5ca'))
