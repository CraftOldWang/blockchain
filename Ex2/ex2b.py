...
def multisig_scriptSig(txin, txout, txin_scriptPubKey):
    ...
    return [OP_0, cust1_sig, bank_sig, txin_scriptPubKey]
    ######################################################################
...
def send_from_multisig_transaction(amount_to_send, txid_to_spend, utxo_index,
    ...
    txin_scriptSig = multisig_scriptSig(txin, txout, redeemScript)
...
if __name__ == '__main__':
    ...
    txid_to_spend = '5d1e3d3fcbd4e91c6e21893149b89d9782913788645964992698e460fdbe575d'
    utxo_index = 0
    ######################################################################
